...
locals {
  ...
  data = {
    ...
    latest   = try(local.result.latest, local.result.latest.error)
    module   = try(local.result.module, local.result.latest.error)
    release  = try(local.result.release, local.result.latest.error)
  }
